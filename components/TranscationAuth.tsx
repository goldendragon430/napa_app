...
const TransactionAuth = () => {
  ...
  const handleLogin = async () => {
    ...
    console.log(pin, 'pin');
    dispatch(fetchProfileData({emailAddress, pin}))
      .then((data: any) => {
        ...
        if (data?.payload) {
          ...
          setPin('');
          toast.show(<WarningToast message='Invalid Pin'/>, {
            placement: 'top',
          });
        }
      })
      .catch((e: any) => {
        toast.show(<WarningToast message={e}/>, {
          placement: 'top',
        });
      });
  };
      ...
      <View
        ...
        <View>
          ...
          <Text style={styles.instractionText}>
            A PIN number protects your Transaction
          </Text>
        </View>
